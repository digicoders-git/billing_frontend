                    ...
                    <div className="grid grid-cols-12 gap-8">
                                            ...
                                            {formData.items.map((item, index) => (
                                                <tr key={item.id} className="hover:bg-gray-50 transition-colors group">
                                                    ...
                                                    <td className="px-4 py-5 text-center">
                                                        <Trash2 
                                                            size={16} 
                                                            className="text-gray-300 hover:text-red-500 cursor-pointer transition-colors opacity-100 mx-auto"
                        ...
                        <div className="col-span-12 lg:col-span-3 space-y-6 text-left">
                            ...
                            <div className="bg-white rounded-3xl border border-gray-200 shadow-sm relative overflow-hidden">
                                <div className="p-6 space-y-6 relative z-10 text-left">
                                    <div className="space-y-4">
                                        <div className="flex justify-between items-center group">
                                            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Subtotal</span>
                                            <span className="text-sm font-black text-gray-800">₹ {totals.subtotal.toLocaleString(undefined, { maximumFractionDigits: 2 })}</span>
                                        </div>

                                        <div className="flex justify-between items-center gap-4 py-2 border-t border-gray-50">
                                            <span className="text-[10px] font-black text-gray-500 uppercase">Additional Charges</span>
                                        ...
                                        <div className="flex justify-between items-center gap-4 py-1">
                                            <div className="flex items-center gap-2">
                                                <span className="text-[10px] font-black text-blue-600 uppercase">Discount</span>
                                                <select 
                                                    value={formData.overallDiscountType}
                                                    onChange={(e) => setFormData({...formData, overallDiscountType: e.target.value})}
                                                    className="text-[9px] bg-blue-50 text-blue-600 border-none rounded px-1 py-0.5 outline-none font-bold uppercase"
                                                >
                                        ...
                                        <div className="pt-4 border-t border-dashed border-gray-100 flex items-center justify-between">
                                            <div className="flex items-center gap-2">
                                                <input 
                                                    ...
                                                    className="w-4 h-4 rounded text-blue-600 border-gray-300 focus:ring-0" 
                                                />
                                                <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Round Off</span>
                                            </div>
                                            {formData.autoRoundOff && <span className="text-[10px] font-black text-gray-400 tabular-nums">₹ {totals.roundOffDiff}</span>}
                                        </div>
                                    </div>

                                    <div className="pt-2">
                                        <div className="bg-gray-900 rounded-2xl p-5 text-white shadow-lg relative overflow-hidden group">
                                            ...
                                            <span className="text-[9px] font-black uppercase tracking-widest opacity-40 block mb-1">Grand Total</span>
                                            <div className="text-2xl font-black tabular-nums relative flex items-center gap-1">
                                                <span className="text-sm font-bold opacity-30">₹</span>
                                                {totals.roundedTotal.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
                                            </div>
                                        </div>
                                    </div>
                                </div>
