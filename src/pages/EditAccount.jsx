    ...
    <DashboardLayout>
      ...
      <div className="flex items-center gap-2 sm:gap-4 mb-6 sm:mb-8">
        ...
        <div className="min-w-0">
          <h1 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 truncate">Edit Account</h1>
          <p className="text-gray-600 mt-1 text-sm sm:text-base">Update account information</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden w-full">
        <div className="px-4 sm:px-6 py-4 border-b border-gray-200 bg-gray-50">
          ...
          <p className="text-sm text-gray-600 mt-1">Update the details below to modify account information</p>
        </div>

        <form onSubmit={handleSubmit} className="p-4 sm:p-6">
          <div className="space-y-6 sm:space-y-8">
            
            {/* Account Type Selection - Disabled in Edit to prevent type mismatch */}
            <div>
              <h4 className="text-md font-semibold text-gray-900 mb-4 flex items-center gap-2">
                <CreditCard size={18} className="text-blue-600 flex-shrink-0" />
                <span className="truncate">Account Type</span>
              </h4>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 opacity-75 pointer-events-none">
              ...
              <p className="text-xs text-gray-500 mt-2 italic">* Account type cannot be changed after creation.</p>
            </div>
            ...
            {/* Financial Setup - Read Only or Restricted */}
            <div>
              <h4 className="text-md font-semibold text-gray-900 mb-4 flex items-center gap-2">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="0"
                  />
                  <p className="text-xs text-red-500 mt-1">Warning: Changing opening balance affects reconciliation.</p>
                </div>
              </div>
            </div>
          </div>
